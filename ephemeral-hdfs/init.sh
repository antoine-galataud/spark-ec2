...
case "$HADOOP_MAJOR_VERSION" in
  1)
    wget http://s3.cn-north-1.amazonaws.com.cn/spark-related-packages/hadoop-1.0.4.tar.gz
    ...
    ;;
  2) 
    wget http://s3.cn-north-1.amazonaws.com.cn/spark-related-packages/hadoop-2.0.0-cdh4.2.0.tar.gz  
    echo "Unpacking Hadoop"
    ...
    ;;
  yarn)
    wget http://s3.cn-north-1.amazonaws.com.cn/spark-related-packages/hadoop-2.4.0.tar.gz
    echo "Unpacking Hadoop"
    tar xvzf hadoop-*.tar.gz > /tmp/spark-ec2_hadoop.log
    rm hadoop-*.tar.gz
