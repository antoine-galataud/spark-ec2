...
DEFAULT_SPARK_GITHUB_REPO = "http://github.com/apache/spark"

# Default location to get the spark-ec2 scripts (and ami-list) from
DEFAULT_SPARK_EC2_GITHUB_REPO = "http://github.com/antoine-galataud/spark-ec2"
DEFAULT_SPARK_EC2_BRANCH = "branch-2.0-china"
